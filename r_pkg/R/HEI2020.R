#' HEI2020 Calculation
#'
#' Calculate the HEI2020 dietary index, Healthy eating index 2020 and HEI-Toddlers-2020, using given the serving sizes of foods and nutrients consumed per 1 day. This version uses the percent of total energy for added sugar and saturated fat and sodium in grams in the original HEI2020.
#' @import dplyr
#' @import readr
#' @import haven
...
#' @param ADDEDSUGAR_SERV_HEI2020 Added sugar, unit=percent of total energy
#' @param SATFAT_SERV_HEI2020 Total Saturated Fatty Acids, unit=percent of total energy
...
HEI2020 = function(SERV_DATA, RESPONDENTID, AGE, TOTALKCAL_HEI2020, TOTALFRT_SERV_HEI2020, FRT_SERV_HEI2020, VEG_SERV_HEI2020, GREENNBEAN_SERV_HEI2020, TOTALPRO_SERV_HEI2020,
    ...
    SERV_DATA = SERV_DATA %>%
        ...
        mutate(
            # calculate the HEI2020 score for each food group given the serving size
            ...
            HEI2020_TOTALFRT = case_when(
                ...
                AGE < 2 & AGE >= 1 ~ HEI2020_HEALTHY1(TOTALFRT_SERV_HEI2020, HEI2020_TODDLERS_MIN_TOTALFRT_SERV, HEI2020_TODDLERS_MAX_TOTALFRT_SERV),
            ),
            HEI2020_FRT = case_when(
                AGE >= 2 ~ HEI2020_HEALTHY1(FRT_SERV_HEI2020, HEI2020_MIN_FRT_SERV, HEI2020_MAX_FRT_SERV),
                AGE < 2 & AGE >= 1 ~ HEI2020_HEALTHY1(FRT_SERV_HEI2020, HEI2020_TODDLERS_MIN_FRT_SERV, HEI2020_TODDLERS_MAX_FRT_SERV),
            ),
            HEI2020_VEG = case_when(
                AGE >= 2 ~ HEI2020_HEALTHY1(VEG_SERV_HEI2020, HEI2020_MIN_VEG_SERV, HEI2020_MAX_VEG_SERV),
                AGE < 2 & AGE >= 1 ~ HEI2020_HEALTHY1(VEG_SERV_HEI2020, HEI2020_TODDLERS_MIN_VEG_SERV, HEI2020_TODDLERS_MAX_VEG_SERV),
            ),
            HEI2020_GREENNBEAN = case_when(
                ...
                AGE < 2 & AGE >= 1 ~ HEI2020_HEALTHY1(GREENNBEAN_SERV_HEI2020, HEI2020_TODDLERS_MIN_GREENNBEAN_SERV, HEI2020_TODDLERS_MAX_GREENNBEAN_SERV),
            ),
            HEI2020_TOTALPRO = case_when(
                ...
                AGE < 2 & AGE >= 1 ~ HEI2020_HEALTHY1(TOTALPRO_SERV_HEI2020, HEI2020_TODDLERS_MIN_TOTALPRO_SERV, HEI2020_TODDLERS_MAX_TOTALPRO_SERV),
            ),
            HEI2020_SEAPLANTPRO = case_when(
                ...
                AGE < 2 & AGE >= 1 ~ HEI2020_HEALTHY1(SEAPLANTPRO_SERV_HEI2020, HEI2020_TODDLERS_MIN_SEAPLANTPRO_SERV, HEI2020_TODDLERS_MAX_SEAPLANTPRO_SERV),
            ),
            HEI2020_WHOLEGRAIN = case_when(
                ...
                AGE < 2 & AGE >= 1 ~ HEI2020_HEALTHY2(WHOLEGRAIN_SERV_HEI2020, HEI2020_TODDLERS_MIN_WHOLEGRAIN_SERV, HEI2020_TODDLERS_MAX_WHOLEGRAIN_SERV),
            ),
            HEI2020_DAIRY = case_when(
                AGE >= 2 ~ HEI2020_HEALTHY2(DAIRY_SERV_HEI2020, HEI2020_MIN_DAIRY_SERV, HEI2020_MAX_DAIRY_SERV),
                AGE < 2 & AGE >= 1 ~ HEI2020_HEALTHY2(DAIRY_SERV_HEI2020, HEI2020_TODDLERS_MIN_DAIRY_SERV, HEI2020_TODDLERS_MAX_DAIRY_SERV),
            ),
            HEI2020_FATTYACID = case_when(
                ...
                AGE < 2 & AGE >= 1 ~ HEI2020_HEALTHY2(FATTYACID_SERV_HEI2020, HEI2020_TODDLERS_MIN_FATTYACID_SERV, HEI2020_TODDLERS_MAX_FATTYACID_SERV),
            ),
            ...
            HEI2020_REFINEDGRAIN = case_when(
                ...
                AGE < 2 & AGE >= 1 ~ HEI2020_UNHEALTHY(REFINEDGRAIN_SERV_HEI2020, HEI2020_TODDLERS_MIN_REFINEDGRAIN_SERV, HEI2020_TODDLERS_MAX_REFINEDGRAIN_SERV),
            ),
            HEI2020_SODIUM = case_when(
                AGE >= 2 ~ HEI2020_UNHEALTHY(SODIUM_SERV_HEI2020, HEI2020_MIN_SODIUM_SERV, HEI2020_MAX_SODIUM_SERV),
                AGE < 2 & AGE >= 1 ~ HEI2020_UNHEALTHY(SODIUM_SERV_HEI2020, HEI2020_TODDLERS_MIN_SODIUM_SERV, HEI2020_TODDLERS_MAX_SODIUM_SERV),
            ),
            HEI2020_ADDEDSUGAR = case_when(
                ...
                AGE < 2 & AGE >= 1 ~ HEI2020_UNHEALTHY(ADDEDSUGAR_SERV_HEI2020, HEI2020_TODDLERS_MIN_ADDEDSUGAR_SERV, HEI2020_TODDLERS_MAX_ADDEDSUGAR_SERV),
            ),
            HEI2020_SATFAT = case_when(
                AGE >= 2 ~ HEI2020_UNHEALTHY(SATFAT_SERV_HEI2020, HEI2020_MIN_SATFAT_SERV, HEI2020_MAX_SATFAT_SERV),
                AGE < 2 & AGE >= 1 ~ HEI2020_UNHEALTHY(SATFAT_SERV_HEI2020, HEI2020_TODDLERS_MIN_SATFAT_SERV, HEI2020_TODDLERS_MAX_SATFAT_SERV),
            ),
